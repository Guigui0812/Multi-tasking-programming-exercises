...
sem_t mutex, thread2, thread3;

// gcc -Wall -pthread  TP3_3.c -lpthread -o TP3_3 && ./TP3_3
...
int main()
{
    ...
    sem_init(&thread2, 0, 0); // Init du mutex
    sem_init(&thread3, 0, 0); // Init du mutex
    ...
    if(pthread_create(&thread3, NULL, threadFunc3, &data) == 0){
